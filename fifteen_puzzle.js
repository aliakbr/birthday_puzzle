...
if(p.keyBoard){document.addEventListener("keydown",function(e){
    e=e.keyCode;
         if(e==37){move_slot(m[freeslot[0]][freeslot[1]+1]);} // Left
    else if(e==39){move_slot(m[freeslot[0]][freeslot[1]-1]);} // Right
    else if(e==38){move_slot(m[freeslot[0]+1][freeslot[1]]);} // Up
    else if(e==40){move_slot(m[freeslot[0]-1][freeslot[1]]);} // Down
})}
